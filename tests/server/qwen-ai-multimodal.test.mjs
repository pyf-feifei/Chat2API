...
test('Docker Compose exposes Qwen timeout overrides under their runtime names', () => {
  ...
  assert.match(source, /CHAT2API_QWEN_AI_STREAM_RESUME_ATTEMPTS:\s*\$\{CHAT2API_QWEN_AI_STREAM_RESUME_ATTEMPTS:-1\}/)
  ...
  assert.match(dockerfile, /ENV CHAT2API_QWEN_AI_STREAM_RESUME_ATTEMPTS=1/)
